...
func init() {
    ...
    flags.StringVar(&rpcurl, "rpcurl", "http://127.0.0.1:8732", "RPC url")
    flags.BoolVar(&noapi, "noapi", false, "disable API server")
    flags.BoolVar(&nopublish, "nopublish", false, "disable ZMQ event publishing")
    ...
    config.SetDefault("log.blockchain", "info")
