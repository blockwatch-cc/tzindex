...
type Chain struct {
	...
	TotalAccounts        int64     `pack:"A,snappy"      json:"total_accounts"`
	TotalContracts       int64     `pack:"C,snappy"      json:"total_contracts"`
	TotalOps             int64     `pack:"O,snappy"      json:"total_ops"`
	TotalContractOps     int64     `pack:"G,snappy"      json:"total_contract_ops"`
	...
	TotalConstants       int64     `pack:"n,snappy"      json:"total_constants"`
	TotalSetLimits       int64     `pack:"L,snappy"      json:"total_set_limits"`
